        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-lg border p-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Barber Commission Rate (%)</label>
                <input
                  type="number"
                  value={shopSettings.barber_commission}
                  onChange={(e) => setShopSettings({...shopSettings, barber_commission: parseInt(e.target.value)})}
                  className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <div>
