export default {
  ...
  whatsappMessage: '📅 *تأكيد الحجز*\n\nعزيزي {{customerName}}،\n\n✅ تم تأكيد حجزك!\n\n📅 التاريخ: {{date}}\n🕐 الوقت: {{time}}\n💇 الخدمة: {{service}}\n👨 الحلاق: {{barber}}\n💰 السعر: {{price}} ₺\n\n📍 الموقع: صالون Edge & Co\n\nشكراً لاختيارك إيانا!\n\n⭐️ يرجى تقييمنا: https://search.google.com/local/reviews?placeid=ChIJswvBq9vJ3hARNtqiZsTOVFE',
  smsMessage: 'تم تأكيد الحجز!\nالتاريخ: {{date}}\nالوقت: {{time}}\nالخدمة: {{service}}\nالحلاق: {{barber}}\nالسعر: {{price}} ₺\nشكراً لاختيارك Edge & Co!\nالتقييم: https://search.google.com/local/reviews?placeid=ChIJswvBq9vJ3hARNtqiZsTOVFE',
